...
internal class SsdMicron : AtaStorage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SsdMicron"/> class.
    /// </summary>
    ...
    protected override void UpdateAdditionalSensors(Kernel32.SMART_ATTRIBUTE[] values)
    {
        ...
        if (!hostProgramPagesCount.HasValue || !ftlProgramPagesCount.HasValue) return;
