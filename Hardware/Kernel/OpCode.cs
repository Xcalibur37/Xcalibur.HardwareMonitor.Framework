...
/// <summary>
/// An Opcode is a single instruction that can be executed by the processor (CPU), which describes the
/// behaviors of an executable file.
/// </summary>
internal static class OpCode
{
    ...
    /// <param name="ecxValue">The ecx value.</param>
